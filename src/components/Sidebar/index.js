...
SideBar.Profile = function SideBarProfile({ heading, displayName, label, children, ...restProps }) {
    return (
        <Profile {...restProps}>
            {children}
            <Label>
...
SideBar.AccountFooter = function SideBarAccountFooter({ children, ...restProps }) {
    return (
