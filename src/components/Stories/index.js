...
import { Container, List, Story, SettingsList, SearchBox, Icons } from './styles/stories';
...
Stories.SettingsList = function StoriesSettingsList({ children, ...restProps }) {
...
Stories.Icons = function StoriesIcons({ children, ...restProps }) {
    return (
        <Icons {...restProps}>
